...
public class loginAdmin extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("usernameAd", username);
        request.setAttribute("passAd", pass);
        request.setAttribute("remAd", rem);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Admin ac = ad.checkAcountAdmin(name, pass);
        ...
        if (ac != null) {
            ...
            Cookie cpass = new Cookie("passwordAd", pass);
            Cookie crem = new Cookie("remAd", rem);
